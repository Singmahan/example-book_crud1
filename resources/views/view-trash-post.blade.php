            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="{{ route('edit_trashed_post', $post->id) }}" class="btn btn-primary btn-sm">Edit</a>
                            <a href="{{ route('restore_post', $post->id) }}" class="btn btn-info btn-sm">Restore</a>
